package dev.shouryapunj.configuration;
...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, OrderCartDTO> producerFactoryJson() throws UnknownHostException {
        ...
        DefaultKafkaProducerFactory<String, OrderCartDTO> factory = new DefaultKafkaProducerFactory<>(configProps);
    ...
    @Bean
    public KafkaTemplate<String, OrderCartDTO> kafkaTemplateJson() throws UnknownHostException {
